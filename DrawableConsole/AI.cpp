...
Vector2 AI::bestMove(string board)
{
...
bool AI::existingMove(string board, Vector2 move)
{
	ifstream newFile(m_filename, ios::binary | ios::in);
	string line;
	Vector2 returnVector = Vector2(rand() % 3, rand() % 3);
...
void AI::addWinMove(string board, Vector2 move)
{
	ifstream newFile(m_filename, ios::binary | ios::in);
	string line;
	Vector2 returnVector = Vector2(rand() % 3, rand() % 3);
...
vector<string> AI::returnBoard(int index)
{
	ifstream newFile(m_filename, ios::binary | ios::in);
	string line;
	vector<string> lines;
...
vector<string> AI::returnWinningMove(int index)
{
	ifstream newFile(m_filename, ios::binary | ios::in);
	string line;
	vector<string> lines;
