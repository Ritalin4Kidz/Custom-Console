...
ConsoleWindow SYDEOldCodeCharacters::draw_truck_syde_001(ConsoleWindow window, Vector2 point)
{
	//OUTLINE 1
	for (int i = -2; i < 29; i++)
	{
...
ConsoleWindow SYDEOldCodeCharacters::draw_girl_diptio_park(ConsoleWindow window, Vector2 point)
{
...
ConsoleWindow SYDEOldCodeCharacters::draw_player(ConsoleWindow window, Vector2 point, ColourClass Clothes1, ColourClass Clothes2, ColourClass Accessory, ColourClass Skin, string lookAngle, string charName)
{
	//PANTS
	for (int i = 0; i < 4; i++)
	{
...
ConsoleWindow SYDEOldCodeCharacters::draw_player_wireframe(ConsoleWindow window, Vector2 point, ColourClass Clothes1, ColourClass Clothes2, ColourClass Accessory, ColourClass Skin, string lookAngle, string charName)
{
	//PANTS
	for (int i = 0; i < 4; i++)
	{
