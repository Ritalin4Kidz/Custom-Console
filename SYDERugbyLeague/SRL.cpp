...
ConsoleWindow SRLGame::CoachingView(ConsoleWindow window, int windowWidth, int windowHeight)
{
	...
	else if (coachDrawState == CoachingTrades_STATE)
	{
		...
		else if (performTradeConfirmedCall)
		{
			...
			m_Season.m_TopPlayers.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopTries.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopGoals.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopPoints.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopMetres.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopFieldGoals.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_Top4020.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopTackles.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopKickMetres.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopErrors.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopPenalty.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopSteals.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopNoTries.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopRuckErrors.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopSinBin.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopSendOff.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);
			m_Season.m_TopInjuries.changePlayerTeam(Player1Character.getName(), m_CoachedTeam.getName(), otherTeamTrade.getName(), playerMainTeamTrade, playerOtherTeamTrade);

			m_Season.m_TopPlayers.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopTries.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopGoals.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopPoints.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopMetres.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopFieldGoals.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_Top4020.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopTackles.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopKickMetres.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopErrors.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopPenalty.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopSteals.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopNoTries.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopRuckErrors.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopSinBin.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopSendOff.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
			m_Season.m_TopInjuries.changePlayerTeam(Player2Character.getName(), otherTeamTrade.getName(), m_CoachedTeam.getName(), playerOtherTeamTrade, playerMainTeamTrade);
...
void SRLGame::offContractTrade()
{
	...
	m_Season.m_TopPlayers.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopTries.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopGoals.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopPoints.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopMetres.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopFieldGoals.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_Top4020.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopTackles.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopKickMetres.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopErrors.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopPenalty.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopSteals.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopNoTries.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopRuckErrors.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopSinBin.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopSendOff.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);
	m_Season.m_TopInjuries.changePlayerTeam(Player1Character.getName(), MainTeam.getName(), offContract.getName(), player1, player2);

	m_Season.m_TopPlayers.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopTries.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopGoals.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopPoints.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopMetres.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopFieldGoals.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_Top4020.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopTackles.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopKickMetres.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopErrors.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopPenalty.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopSteals.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopNoTries.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopRuckErrors.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopSinBin.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopSendOff.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
	m_Season.m_TopInjuries.changePlayerTeam(Player2Character.getName(), offContract.getName(), MainTeam.getName(), player2, player1);
