...
int main(int argc, char* argv[])
{
	...
	SYDEKeyCode::KeyCodes_Optimized.push_back(SYDEKey('F'));
	SYDEKeyCode::KeyCodes_Optimized.push_back(SYDEKey('G'));
	...
	while (true)
	{
		window = SYDEGamePlay::play(&m_SoundDemo, start, hOut, window, windowWidth, windowHeight, deltaTime);
